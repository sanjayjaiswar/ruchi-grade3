...
- Lesson routes exist for all 152 lessons. Module 1 Lesson 1 is deeply authored from its lesson pages; the other routes are objective-backed lesson flows that avoid invented lesson-specific examples.
...
- Module 1 Lesson 1 displays a deeply authored lesson-page flow.

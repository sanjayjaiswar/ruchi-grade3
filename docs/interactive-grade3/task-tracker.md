...
| Module 1 problem-set-centered replication | Structurally converted; exact-source fidelity gaps remain | Lessons 1-11 and 13-21 receive Module 1-only problem-set-centered runtime data; Lesson 12 keeps its bespoke pilot data and now has the same Teacher Edition page-image source references. The Module 1 Teacher Edition pages 23-276 were rendered to local app assets, all visible Module 1 source wording was changed to Teacher Edition-only, and Chrome session `🔎 Module 1 audit` clicked all 21 Module 1 lessons through Concept, Problem Set Blank, every Problem bookmark, Problem Set Solved, and Summary. The audit verified Teacher Edition images, no old rail, no visible workbook wording, 114/114 Blank visual cards, 114/114 Solved visual cards, and animation markers on every lesson. Lesson 10 decomposed-array visuals were repaired from the Teacher Edition Problem Set. Remaining gap: do not mark 100% fulfilled until every prompt, solved explanation, and image-heavy visual is checked problem-by-problem against the Teacher Edition; at least Lesson 10 Problem 3 remains shortened from the official Ruby photo-album prompt, and solved views still use typed reconstructions/shared animation families rather than per-problem cropped Teacher Edition solved work. |
| Module 2 problem-set-centered replication | Remediated structurally; exact visual gaps remain | Lessons 1-21 now receive Module 2-only problem-set-centered runtime data from the Teacher Edition source. After the failed source-fidelity review, all 93 Problem Set cards received Teacher Edition-derived prompt overrides, Teacher Edition Answer Key solved-answer overrides, validation blocks, and Solved-mode answer-key page images. Chrome QA clicked all 21 Module 2 lessons from visible Topic lesson cards through Concept, Problem Set Blank, Problem Set Solved, Summary, and every Problem bookmark. Follow-up audit verified 93/93 prompts, 0 generic prompt buckets, 93/93 Teacher Edition Answer Key explanation blocks, 93/93 validation blocks, answer-key source images in Solved mode, and 0 broken answer-key images. Remaining gap: exact source-image-only clocks, scales, containers, and variable measurement items are still source-referenced/shared-model visualizations rather than per-problem Teacher Edition-cropped solved work or bespoke manipulatives. |
| Module 3 problem-set-centered replication | Done with audited visual support | Lessons 1-21 now receive Module 3-only problem-set-centered runtime data controlled by the Teacher Edition lesson references and Teacher Edition Answer Key results. Chrome session `G3-M3` clicked Concept, Problem Set Blank, all 93 Problem bookmarks, Problem Set Solved, and Summary with 0 failures. Extracted lesson-objective tails were removed from rendered problem prompts by exact lesson/problem key, and every solved card now has either a source-derived model or animated equation-flow support instead of a PDF-only or source-only placeholder. Bespoke Teacher Edition-cropped visuals can still improve table/riddle/pattern and image-heavy/open items, but the current Module 3 pass is not a PDF dump and no solved cards are unsupported. |
| Module 4 problem-set-centered replication | Failed source-fidelity audit | Lessons 1-16 receive Module 4-only problem-set-centered runtime data and the control flow renders. Chrome QA in `🔎 G3-M4 audit` clicked all 16 lesson routes from visible topic cards through Concept, Problem Set, Blank, Solved, Summary, and every Problem bookmark. The audit found the module is not fulfilled: Blank mode leaks answer-key values in multiple lessons, solved views for Lessons 2-15 do not visibly preserve all checked Teacher Edition answer-key snippets, M4-specific visuals are static, and Lessons 4, 13, and 16 lack M4-specific solved visual containers. |
| Module 5 problem-set-centered replication | In progress with Teacher Edition remediation | PDF-page takeover was removed from the primary experience. Module 5 now uses a Module 5-only workbook problem map extracted from official source layout text, plus interactive model rows. Lesson 1 has a Teacher Edition-authored beaker/string-cheese/rectangle/paper-sheet/wood-strip implementation from printed pages 12-18, and Lesson 30 has a Teacher Edition-authored lined-paper/red-strip partition animation matching pages 353-354. Chrome validation passed for Lesson 1 on a fresh build at `localhost:4305`; Lesson 30 passed earlier. Remaining gap: Lessons 2-29 still need the same Teacher Edition-authored source pass where generic model rows remain. |
| Module 6 problem-set-centered replication | Done after Teacher Edition correction pass | Lessons 1-9 now use authored interactive Module 6 displays and Teacher Edition-derived concept animation panels: tally/picture graphs, vertical tape displays, bar graphs, ruler/measurement work, and line plots. Follow-up Teacher Edition visual audit corrected Lesson 6 `53 1/2`, Lesson 7 `2 1/4` / `2 3/4` / `2 2/4`, and Lessons 7-9 source measurement tables. Chrome session `G3-M6` clicked every lesson route, Concept / Problem Set / Summary, Blank / Solved, and every Problem bookmark with 0 failures and 0 console errors. |
| Module 7 problem-set-centered replication | Failed visual/animation fulfillment audit | Lessons 1-34 receive Module 7 problem-set-centered runtime data, and Teacher Edition Problem Set/Answer Key page mapping is accurate. Chrome + Computer audit in tab group `🔎 G3-M7` clicked all 34 lessons/tabs/modes/problem bookmarks and found data/source pages passed, but 0 of 34 lessons passed authored problem-level visual/animation fulfillment: Solved cards are still source-page-only. |
...
| Module 2 problem-set-centered replication | Remediated structurally; exact visual gaps remain | Codex | Module 2 lessons now use Concept / Problem Set / Summary with `Blank | Solved` mode; `npm run build` passed. Chrome QA clicked all 21 lessons from visible Topic lesson cards through Concept, Problem Set Blank, Problem Set Solved, Summary, and all Problem bookmarks. The follow-up Teacher Edition audit verified 93/93 prompts, 0 generic prompt buckets, 93/93 Teacher Edition Answer Key explanation blocks, 93/93 validation blocks, answer-key source images in Solved mode, and 0 broken answer-key images. Remaining visual gap: image-heavy clock/scale/container/variable-measurement items still need exact Teacher Edition-cropped solved work or bespoke manipulatives. |
| Module 3 problem-set-centered replication | Done with audited visual support | Codex | Module 3 lessons now use Concept / Problem Set / Summary with `Blank | Solved` mode; `npm run build` passed. Chrome session `G3-M3` clicked all 21 lessons through Concept, Problem Set Blank, all 93 Problem bookmarks, Problem Set Solved, and Summary with 0 failures. The final pass verified 93 solved cards, 0 unsupported solved visuals, 93 concrete/model markers, and 71 animated equation-flow markers. Lesson-objective extraction tails were removed from rendered prompt headings by exact lesson/problem key. The UI keeps source pages collapsed as references, shows interactive cards, cites the Teacher Edition Answer Key, and removes fake `1 groups of 1 units`/source-only solved cards. |
| Module 4 problem-set-centered replication | Failed source-fidelity audit | Codex | Module 4 lessons use Concept / Problem Set / Summary with `Blank | Solved` mode and `npm run build` passed. Chrome session `🔎 G3-M4 audit` clicked all 16 lessons from visible topic cards through Concept, Problem Set, Blank, Solved, Summary, and every Problem bookmark. Control flow passed, but source fidelity failed because Blank leaks answers, solved views miss checked Teacher Edition answer-key snippets, M4 visuals are static, and Lessons 4, 13, and 16 lack M4-specific solved visuals. |
...
| Module 6 problem-set-centered replication | Done after Teacher Edition correction pass | Codex | Module 6 Lessons 1-9 now expose Concept / Problem Set / Summary and `Blank | Solved` controls with authored graph/tape/ruler/line-plot displays and Teacher Edition-derived concept animations. The correction pass fixed Lesson 6 `53 1/2`, Lesson 7 thresholds/absent-student wording, Teacher Edition table-shaped source data for Lessons 7-9, and Lesson 9 grass counts. `npm run build` and full Chrome visual/source click QA passed. |
| Module 7 problem-set-centered verification | Failed visual/animation fulfillment audit | Codex | Teacher Edition page-image remediation is wired and `npm run build` passes. In-app Browser and Chrome audits clicked all 34 Module 7 lessons through Concept, Problem Set Blank, every Problem bookmark, Problem Set Solved, every Problem bookmark again, and Summary. Teacher Edition page accuracy passed, but the Chrome visual audit found all Solved problem cards are source-page-only with 0 authored problem visual cards. |

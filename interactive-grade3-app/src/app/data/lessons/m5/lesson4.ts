...
export const M5_LESSON4_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "fraction",
    "whole"
  ],
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Represent and identify fractional parts of different wholes.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_5/g3_m5_teacher_edition_v1_3_0.pdf, pages 41-53. Lesson 4 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Represent and identify fractional parts of different wholes."
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 4 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "What was the same at each station? What was different?"
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 4 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 5 Teacher Edition, lesson pages 41-53."
      },
      {
        label: "Source text",
        value: "Use the Teacher Edition lesson pages 41-53 for the exact teacher explanation and support sequence."

...
export const M5_LESSON12_RUNTIME: LessonRuntimeConfig = {
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Specify the corresponding whole when presented with one equal part.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_5/g3_m5_teacher_edition_v1_3_0.pdf, pages 136-147. Lesson 12 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Specify the corresponding whole when presented with one equal part."
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 12 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "What were the different wholes we saw at each station that were the same?"
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 12 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 5 Teacher Edition, lesson pages 136-147."
      },
      {
        label: "Source text",
        value: "Problem Set (10 minutes) Students should do their personal best to complete the Problem Set within the allotted 10 minutes. For some classes, it may be appropriate to modify the assignment by specifying which problems they work on first. Some problems do not specify a method for solving. Students should solve these problems using the RDW approach used for Application Problems. G 3-M 5-TE-1.3.0 -0 6.2 0 15"

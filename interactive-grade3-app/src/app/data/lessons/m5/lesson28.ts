...
export const M5_LESSON28_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "fraction",
    "whole"
  ],
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Compare fractions with the same numerator pictorially.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_5/g3_m5_teacher_edition_v1_3_0.pdf, pages 329-339. Lesson 28 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Compare fractions with the same numerator pictorially."
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 28 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "Look at your answers for Problems 7 and 8. Is 2 parts always equal to 2 parts? Why or why not?"
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 28 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 5 Teacher Edition, lesson pages 329-339."
      },
      {
        label: "Source text",

...
export const M5_LESSON3_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit",
    "fraction",
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Specify and partition a whole into equal parts, identifying and counting unit fractions by drawing pictorial area models.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_5/g3_m5_teacher_edition_v1_3_0.pdf, pages 31-40. Lesson 3 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Specify and partition a whole into equal parts, identifying and counting unit fractions by drawing pictorial area models."
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 3 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "What is the same about fair shares of a jug of milk and fair shares of a candy bar? What is different? (Though a fraction of a jug of milk and a fraction of a candy bar is clearly different, each might be represented by drawing a rectangle.)"
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 3 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 5 Teacher Edition, lesson pages 31-40."
      },
      {
        label: "Source text",
        value: "Problem Set (10 minutes) Students should do their personal best to complete the Problem Set within the allotted 10 minutes. For some classes, it may be appropriate to modify the assignment by specifying which problems they work on first. Some problems do not specify a method for solving. Students should solve these problems using the RDW approach used for Application Problems."

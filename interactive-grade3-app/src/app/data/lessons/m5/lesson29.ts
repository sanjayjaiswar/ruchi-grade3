...
export const M5_LESSON29_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "fraction",
    "whole"
  ],
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Compare fractions with the same numerator using <, >, or =, and use a model to reason about their size.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_5/g3_m5_teacher_edition_v1_3_0.pdf, pages 340-351. Lesson 29 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Compare fractions with the same numerator using <, >, or =, and use a model to reason about their size."
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 29 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "Today, we'll only use the first rectangle. At my signal, draw and 1 shade a fraction less than 2, and label it below the rectangle. (Signal.)"
      },
      {
        label: "Workbook",
        value: "Module 5 student workbook, Lesson 29 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 5 Teacher Edition, lesson pages 340-351."
      },
      {
        label: "Source text",
        value: "Problem Set (10 minutes) NOTES ON Students should do their personal best to complete the Problem Set within the allotted 10 minutes. For some classes, it may be MULTIPLE MEANS appropriate to modify the assignment by specifying which OF ACTION AND problems they work on first. Some problems do not specify a EXPRESSION: method for solving. Students should solve these problems using English language learners and students the RDW approach used for Application Problems. working below grade level may benefit from math (and English) fluency practice using the P..."

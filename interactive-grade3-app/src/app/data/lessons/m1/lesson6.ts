...
export const M1_LESSON6_RUNTIME: LessonRuntimeConfig = {
  ...
  teacherEditionSteps: [
    ...
    },
    {
      ...
      teacherEditionBasis: "Problem Set (10 minutes): Students complete the Lesson 6 Problem Set using the lesson models from the Teacher Edition.",
      visualModel: "array"
    },
    {
      id: "source-picture",
      ...
      teacherEditionBasis: "Module 1 Teacher Edition, Lesson 6 Problem Set.",
      visualModel: "array"
    },
    {
      id: "source-draw",
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the official Lesson 6 Problem Set workspace and source-backed visuals to model and solve the student-facing problems.",
    ...
    },
    {
      ...
      shortTitle: "Sum",
      studentPrompt: "Debrief focus: connect the Problem Set models and answers to the Lesson 6 objective: Interpret the unknown in division using the array model.",
      teacherEditionBasis: "Module 1 Teacher Edition, lesson pages 85-94.",
      visualModel: "array"
    }
  ],
  sourceRows: {
    "source-goal": [
      ...
      },
      {
        ...
        value: "Module 1 Teacher Edition, Lesson 6 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      {
        label: "Source",
        value: "Problem Set (10 minutes): Students complete the Lesson 6 Problem Set using the lesson models from the Teacher Edition."
      },
      {
        label: "Source text",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the official Lesson 6 Problem Set workspace and source-backed visuals to model and solve the student-facing problems."
      },
      {
        label: "Teacher Edition",
        value: "Module 1 Teacher Edition, Lesson 6 Problem Set."
    ...
    "source-summary": [
      ...
      {
        label: "Source text",
        value: "Debrief focus: connect the Problem Set models and answers to the Lesson 6 objective: Interpret the unknown in division using the array model."
      },
      {
        label: "Teacher Edition",
        value: "Module 1 Teacher Edition, Lesson 6 Problem Set."

...
export const M7_LESSON1_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "unknown",
    "unknown factor"
  ],
  ...
  teacherEditionSteps: [
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 1 RDW word-problem model with quantities, labels, units, and written answer evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 15-26. Lesson 1 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 1 RDW word-problem model with quantities, labels, units, and written answer evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 1 Problem Set."

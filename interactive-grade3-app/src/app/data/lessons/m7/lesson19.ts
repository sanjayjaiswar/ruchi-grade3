...
export const M7_LESSON19_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "line plot",
    "scale",
    "angle"
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Use a line plot to record the number of rectangles constructed from a given number of unit squares.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 19 rectangle, area, perimeter, and line-plot workspace with source dimensions and plotted evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 259-268. Lesson 19 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Use a line plot to record the number of rectangles constructed from a given number of unit squares."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 19 rectangle, area, perimeter, and line-plot workspace with source dimensions and plotted evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 19 Problem Set."

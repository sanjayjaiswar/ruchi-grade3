...
export const M7_LESSON12_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "perimeter"
  ],
  lessonAnimation: {
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Measure side lengths in whole number units to determine the perimeter of polygons.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 12 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 158-169. Lesson 12 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Measure side lengths in whole number units to determine the perimeter of polygons."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 12 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 12 Problem Set."

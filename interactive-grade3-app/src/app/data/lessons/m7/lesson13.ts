...
export const M7_LESSON13_RUNTIME: LessonRuntimeConfig = {
  ...
  teacherEditionSteps: [
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 13 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 13 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 13 Problem Set."

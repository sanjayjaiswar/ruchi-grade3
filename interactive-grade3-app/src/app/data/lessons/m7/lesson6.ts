...
export const M7_LESSON6_RUNTIME: LessonRuntimeConfig = {
  ...
  teacherEditionSteps: [
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 6 polygon attribute workspace with source shapes, labels, sides, angles, and classification evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 6 polygon attribute workspace with source shapes, labels, sides, angles, and classification evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 6 Problem Set."

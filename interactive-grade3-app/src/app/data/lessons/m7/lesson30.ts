...
export const M7_LESSON30_RUNTIME: LessonRuntimeConfig = {
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Share and critique peer strategies for problem solving.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 30 critique, reflection, or fluency workspace with the official response structure to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 392-419. Lesson 30 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Share and critique peer strategies for problem solving."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 30 critique, reflection, or fluency workspace with the official response structure to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 30 Problem Set."

...
export const M7_LESSON16_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "perimeter",
    "round"
  ],
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Use string to measure the perimeter of various circles to the nearest quarter inch.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 16 circular-object perimeter workspace with string measurement, nearest quarter-inch units, and yes/no check evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 207-219. Lesson 16 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Use string to measure the perimeter of various circles to the nearest quarter inch."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 16 circular-object perimeter workspace with string measurement, nearest quarter-inch units, and yes/no check evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 16 Problem Set."

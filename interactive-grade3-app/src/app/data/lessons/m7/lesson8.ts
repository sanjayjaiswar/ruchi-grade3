...
export const M7_LESSON8_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "gram"
  ],
  lessonAnimation: {
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Create a tangram puzzle and observe relationships among the shapes.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 8 polygon composition workspace with source pieces, joins, outlines, and labels to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 114-125. Lesson 8 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Create a tangram puzzle and observe relationships among the shapes."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 8 polygon composition workspace with source pieces, joins, outlines, and labels to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 8 Problem Set."

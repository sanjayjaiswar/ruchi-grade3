...
export const M7_LESSON10_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "perimeter"
  ],
  lessonAnimation: {
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Decompose quadrilaterals to understand perimeter as the boundary of a shape.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 10 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 140-150. Lesson 10 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Decompose quadrilaterals to understand perimeter as the boundary of a shape."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 10 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 10 Problem Set."

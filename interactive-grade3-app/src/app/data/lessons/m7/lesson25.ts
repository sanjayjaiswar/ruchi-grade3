...
export const M7_LESSON25_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit",
    "perimeter",
  ...
  teacherEditionSteps: [
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 25 robot planning, drawing, measurement, and evaluation workspace with the official chart rows and perimeter relationships to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 332-341. Lesson 25 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 25 robot planning, drawing, measurement, and evaluation workspace with the official chart rows and perimeter relationships to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 25 Problem Set."

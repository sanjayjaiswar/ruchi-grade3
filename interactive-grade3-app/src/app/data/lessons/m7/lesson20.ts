...
export const M7_LESSON20_RUNTIME: LessonRuntimeConfig = {
  ...
  teacherEditionSteps: [
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 20 rectangle, area, perimeter, and line-plot workspace with source dimensions and plotted evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 20 rectangle, area, perimeter, and line-plot workspace with source dimensions and plotted evidence to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 20 Problem Set."

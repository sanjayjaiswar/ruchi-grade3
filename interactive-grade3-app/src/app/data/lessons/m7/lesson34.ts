...
export const M7_LESSON34_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [],
  lessonAnimation: {
    kind: "geometry",
  ...
  teacherEditionSteps: [
    {
      id: "source-goal",
      title: "Lesson 34: source objective",
      shortTitle: "Goal",
      studentPrompt: "Create resource booklets to support fluency with Grade 3 skills.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 34 critique, reflection, or fluency workspace with the official response structure to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 454-462. Lesson 34 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Create resource booklets to support fluency with Grade 3 skills."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 34 critique, reflection, or fluency workspace with the official response structure to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 34 Summer Calendar."

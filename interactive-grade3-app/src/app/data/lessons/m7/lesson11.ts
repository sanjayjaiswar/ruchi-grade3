...
export const M7_LESSON11_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "perimeter"
  ],
  lessonAnimation: {
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Tessellate to understand perimeter as the boundary of a shape.",
    ...
    },
    {
      ...
      shortTitle: "Draw",
      studentPrompt: "Use the Lesson 11 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_7/g3_m7_teacher_edition_v1_3_1.pdf, pages 151-157. Lesson 11 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Tessellate to understand perimeter as the boundary of a shape."
      },
      {
        label: "Workbook",
    ...
    "source-draw": [
      ...
      {
        label: "Source text",
        value: "Use the Lesson 11 perimeter workspace with the source side lengths, labels, units, and boundary reasoning to model and solve the student-facing problems with authored diagrams, labels, measurements, and response blanks."
      },
      {
        label: "Workbook",
        value: "Module 7 Teacher Edition, Lesson 11 Problem Set."

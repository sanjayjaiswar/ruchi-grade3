...
export const M4_LESSON13_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit",
    "angle"
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Find areas by decomposing into rectangles or completing composite figures to form rectangles.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_4/g3_m4_teacher_edition_v1_3_0.pdf, pages 161-172. Lesson 13 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Find areas by decomposing into rectangles or completing composite figures to form rectangles."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 13 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "How did you break apart the rectangles in Figure 4? Did anyone break apart the rectangles in a different way? (A rectangle of 10 by 2.) Lesson 13: Find areas by decomposing into rectangles or completing composite 164 figures to form rectangles."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 13 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 4 Teacher Edition, lesson pages 161-172."
      },
      {
        label: "Source text",
        value: "Problem Set (10 minutes) Students should do their personal best to complete the Problem Set within the allotted 10 minutes. For some classes, it may be appropriate to modify the assignment by specifying which problems they work on first. Some problems do not specify a method for solving. Students should solve these problems using the RDW approach used for Application Problems."

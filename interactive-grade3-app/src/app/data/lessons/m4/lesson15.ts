...
export const M4_LESSON15_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit"
  ],
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Apply knowledge of area to determine areas of rooms in a given floor plan.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_4/g3_m4_teacher_edition_v1_3_0.pdf, pages 185-195. Lesson 15 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Apply knowledge of area to determine areas of rooms in a given floor plan."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 15 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "For the next two days, you are going to be architects. refer to the optional activities Today you are going to use a floor plan that your suggested in Lesson 16. clients designed to find the area in square centimeters of each room in the house."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 15 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 4 Teacher Edition, lesson pages 185-195."
      },
      {
        label: "Source text",
        value: "Problem Set (20 minutes) NOTES ON Students should do their personal best to complete the Problem MULTIPLE MEANS Set within the allotted 20 minutes. For some classes, it may be OF ACTION AND appropriate to modify the assignment by specifying which EXPRESSION: problems they work on first. Some problems do not specify a To ease the task of constructing a method for solving. Students should solve these problems using response for Problems 3-5 of the the RDW approach used for Application Problems. Problem Set, allow English language learners and others to di..."

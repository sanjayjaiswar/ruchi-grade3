...
export const M4_LESSON14_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit",
    "angle"
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_4/g3_m4_teacher_edition_v1_3_0.pdf, pages 173-184. Lesson 14 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
      ...
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 14 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "Lead a discussion about the strategy choice for Problems 1(a) and 1(b). Could the strategies have been reversed for these two problems?"
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 14 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 4 Teacher Edition, lesson pages 173-184."
      },
      {
        label: "Source text",

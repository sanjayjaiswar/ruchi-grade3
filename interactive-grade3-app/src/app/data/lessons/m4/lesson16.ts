...
export const M4_LESSON16_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit"
  ],
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_4/g3_m4_teacher_edition_v1_3_0.pdf, pages 196-204. Lesson 16 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
      ...
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 16 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "Explain to a partner how you found the side lengths of the whole house without using your ruler to measure."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 16 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 4 Teacher Edition, lesson pages 196-204."
      },
      {
        label: "Source text",

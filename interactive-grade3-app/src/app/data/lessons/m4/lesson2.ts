...
export const M4_LESSON2_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit",
    "decompose"
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Decompose and recompose shapes to compare areas.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_4/g3_m4_teacher_edition_v1_3_0.pdf, pages 21-31. Lesson 2 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Decompose and recompose shapes to compare areas."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 2 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "Talk to a partner. What new units did we define today?"
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 2 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 4 Teacher Edition, lesson pages 21-31."
      },
      {
        label: "Source text",

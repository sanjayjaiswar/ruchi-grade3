...
export const M4_LESSON3_RUNTIME: LessonRuntimeConfig = {
  conceptTerms: [
    "area",
    "square unit",
    "elapsed time"
  ...
  teacherEditionSteps: [
    {
      ...
      shortTitle: "Goal",
      studentPrompt: "Model tiling with centimeter and inch unit squares as a strategy to measure area.",
  ...
  sourceRows: {
    "source-goal": [
      {
        label: "Source",
        value: "EurekaMath-Sources/Module_4/g3_m4_teacher_edition_v1_3_0.pdf, pages 32-43. Lesson 3 objective, concept development, problem set, exit ticket, and homework."
      },
      {
        label: "Source text",
        value: "Model tiling with centimeter and inch unit squares as a strategy to measure area."
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 3 Problem Set."
      }
    ],
    "source-model": [
      {
    ...
    "source-meaning": [
      ...
      {
        label: "Source text",
        value: "How are the rectangles in Problems 1(b) and 1(c) the same? How are they different?"
      },
      {
        label: "Workbook",
        value: "Module 4 student workbook, Lesson 3 Problem Set."
    ...
    "source-draw": [
      {
        label: "Source",
        value: "Module 4 Teacher Edition, lesson pages 32-43."
      },
      {
        label: "Source text",

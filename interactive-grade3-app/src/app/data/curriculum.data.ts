...
export const MODULES: ModuleMeta[] = [
  ...
  },
  {
    ...
    summary:
      'Module 2 uses time, metric weight, metric liquid volume, rounding, and measurement contexts to strengthen place value and problem solving.',
    ...
    topics: [
      ...
      },
      {
        id: 'm2-tb',
        label: 'Topic B',
        title: 'Measuring Weight and Liquid Volume with Metric Units',
        days: 6,
...
const LESSON_OBJECTIVES: Record<string, string> = {
  ...
  'm2-l7': 'Develop estimation strategies by reasoning about the weight in kilograms and grams of familiar objects to establish mental benchmark measures.',

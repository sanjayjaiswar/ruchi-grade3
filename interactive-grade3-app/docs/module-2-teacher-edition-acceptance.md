...
- Repeatable repair workflow: `.agents/skills/fix-eureka-lesson/SKILL.md`; Lesson 20 baseline and non-drift criteria: `.agents/skills/fix-eureka-lesson/references/lesson-20-baseline.md`.
